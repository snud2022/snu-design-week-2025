...
// peopleGraphicConfigs 인덱스와 카테고리 매핑
export const FILTER_INDEX_TO_CATEGORY: Record<number, Category> = {
  0: "BRAND",
  1: "GRAPHIC",
  2: "MEDIA",
  3: "UI/UX",
...
export const CATEGORY_TO_FILTER_INDEX: Record<Category, number | null> = {
  ALL: null,
  BRAND: 0,
  GRAPHIC: 1,
  MEDIA: 2,
...
export const getCategoryGraphic = (category: Category): CategoryGraphic => {
  ...
  const filterIndex = CATEGORY_TO_FILTER_INDEX[category];

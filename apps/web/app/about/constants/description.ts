...
export const ABOUT_CONTENT: AboutContent = {
  ...
  descriptionEn: `WRAP UP, Seoul National University Department of Design's Graduation Exhibition of 2025, unfolds as a moving scene of packing up four years' worth of belongings.
  ...
  If so, what are the things we've wrapped into these boxes? And where
  are we heading next with these firmly tied loads alongside us? We kindly invite you to the site of WRAP UP, where the experiences and moments we've collected throughout the years are carefully wrapped.`,
};
